...
![Badge: Acessibilidade](https://img.shields.io/badge/Acessibilidade-WCAG%202.1%20%2F%202.2-blue)
![Badge: QA](https://img.shields.io/badge/QA-Engenharia%20de%20Qualidade-green)
![Badge: Inclusão](https://img.shields.io/badge/Inclus%C3%A3o-Digital-yellow)
...
*Compartilhando conhecimento sobre inclusão digital.*
...
* 🚀 **[Framework de Automação com Cypress-Axe](./projects/automacao-a11y)**: Modelo de como integrar testes de acessibilidade no CI/CD.
* 📱 **[Auditoria Completa: App Mobile de Finanças](./projects/estudo-financas)**: Estudo de caso real sobre melhoria de navegação por gestos. -->
